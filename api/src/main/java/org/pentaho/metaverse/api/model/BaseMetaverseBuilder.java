...
public class BaseMetaverseBuilder extends MetaverseObjectFactory implements IMetaverseBuilder {
  ...
  protected void registerStaticNodes() {
    ...
    addEntityType( DictionaryConst.NODE_TYPE_SPLUNK_CONNECTION, DictionaryConst.NODE_TYPE_EXTERNAL_CONNECTION );
    addEntityType( DictionaryConst.NODE_TYPE_SPLUNK_FIELD, null );
